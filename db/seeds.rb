...
user5 =User.create(username: "Ines", password: "ines")

Item.create(name: 'Postion', description: 'lalalal', user_id: user1.id )
Item.create(name: 'HEllo', description: 'heheh', user_id: user2.id )

refugee = Charity.create(name: "Everyone is welcome", description: "We are a charity based in London that helps asylum seekers apply for refugee status and, in parallel, help refugees settle in the UK.", address: "East London", website:"www.everyonewelcome.org.uk", logo: "./everyones-welcome.png")

lgbt = Charity.create(name: "Inclusive Rights", description:"We're an LGBTQ+ focused charity that provides advice and services for the community. Our strong presence helps us advocate for more inclusive laws and fight discriminatory practices.", address: "Camden, London", website:"www.inclusiverights.org.uk", logo: "./inclusive-rights.png")

thefreedomproject = Charity.create(name: "The Freedom Project", description:"The freedom project has been helping victims of domestic violence and trafficking since 1982. By providing shelters, education, advice and legal services, we help women leave their abusive relationships and begin a new life", address: "Elephant and Castle, London", website:"www.thefreedomproject.org.uk", logo: "./the-freedom-project.png")
